...
const productsData = {
  ...
  bebidas: [
    { id: 13, title: "Água com gás", description: "Refrescante água com gás", price: 3.0,  image: "https://imagizer.imageshack.com/img923/5153/Jt7YY9.png", category: "bebidas" },
...
const optionsData = {
  ...
  adicionais: {
    title: "ADICIONAIS",
    items: [
      { id: 12, name: "LEITE EM PÓ", price: 0 },
      { id: 13, name: "AMENDOIM", price: 0 },
      { id: 14, name: "AMENDOIM CONFEITADO", price: 0 },
      { id: 15, name: "AMENDOIM CROCANTE", price: 0 },
      { id: 16, name: "AVEIA", price: 0 },
      { id: 17, name: "BALAS FINNIS", price: 0 },
      { id: 18, name: "BANANA", price: 0 },
      { id: 19, name: "CALDA DE AMEIXA", price: 0 },
      { id: 20, name: "CALDA DE MORANGO", price: 0 },
      { id: 21, name: "CANUDINHO", price: 0 },
      { id: 22, name: "CASTANHA", price: 0 },
      { id: 23, name: "CASTANHA CARAMELIZADA", price: 0 },
      { id: 24, name: "CASTANHA TRITURADA", price: 0 },
      { id: 25, name: "CEREAL BAAL", price: 0 },
      { id: 26, name: "CEREJA", price: 0 },
      { id: 27, name: "CHOCOBOOL", price: 0 },
      { id: 28, name: "CREME COOKIES", price: 0 },
      { id: 29, name: "CREME COOKIES CHOCOLATE BRANCO", price: 0 },
      { id: 30, name: "CREME COOKIES CHOCOLATE PRETO", price: 0 },
      { id: 31, name: "DOCE DE LEITE", price: 0 },
      { id: 32, name: "FARINHA LACTEA", price: 0 },
      { id: 33, name: "FLOCOS DE ARROZ", price: 0 },
      { id: 34, name: "FLOCOS DE TAPIOCA", price: 0 },
      { id: 35, name: "GANACHE", price: 0 },
      { id: 36, name: "GOTAS DE CHOCOLATE", price: 0 },
      { id: 37, name: "GRANOLA", price: 0 },
      { id: 38, name: "GRANULADO COLORIDO", price: 0 },
      { id: 39, name: "GRANULADO DE CHOCOLATE", price: 0 },
      { id: 40, name: "JUJUBA", price: 0 },
      { id: 41, name: "KIWI", price: 0 },
      { id: 42, name: "LEITE CONDENSADO", price: 0 },
      { id: 43, name: "MARSHMALLOW", price: 0 },
      { id: 44, name: "MINI CEREAL COLORIDO", price: 0 },
      { id: 45, name: "MMS GRANDE", price: 0 },
      { id: 46, name: "MMS PEQUENO", price: 0 },
      { id: 47, name: "MORANGO", price: 0 },
      { id: 48, name: "OVOMALTINE", price: 0 },
      { id: 49, name: "PAÇOQUITA", price: 0 },
      { id: 50, name: "SUCRILHO", price: 0 },
      { id: 51, name: "UVA", price: 0 },
    ],
  },
  coberturas: {
    title: "COBERTURAS",
    items: [
      { id: 52, name: "CARAMELO", price: 0 },
      { id: 53, name: "CEREJA", price: 0 },
      { id: 54, name: "CHOCOLATE", price: 0 },
      { id: 55, name: "DOCE DE LEITE", price: 0 },
      { id: 56, name: "KIWI", price: 0 },
      { id: 57, name: "MENTA", price: 0 },
      { id: 58, name: "MORANGO", price: 0 },
      { id: 59, name: "TUTTI FRUTTI", price: 0 },
    ],
  },
  extra: {
    title: "EXTRA",
